...
var _sys = __webpack_require__(121);
...
var sysManager = new _sys2.default(router);
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(20).concat(__webpack_require__(34)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
...
var _os = __webpack_require__(122);
...
var SystemManager = function () {
  function SystemManager(router) {
    ...
    this.getLocalIP().then(function (ip) {
      console.log("Laser happens on http://" + ip + ":" + _this.port + "/v1.0");
      _this.sendGitIp(ip);
    }.bind(this));
    router.get("/", function (req, res) {
      res.sendFile(_path2.default.join(self.publicDir() + "/index.html"));
    });
    this.initUser();
  }
  /**
  ...
  _createClass(SystemManager, [{
    ...
    value: function publicDir() {
      return _path2.default.resolve(__dirname + "/../public/", "");
    }
    /**
     * 获取web路由
     */
    ...
    value: function initUser() {
      if (!_localStorage2.default.get("user")) {
        _localStorage2.default.set("user", { uuid: (0, _v2.default)(), name: "" });
      } else {
        this.log("user exist!");
      }
    }
    ...
    value: function getUUID() {
      var user = _localStorage2.default.get("user");
      if (!user) {
        _localStorage2.default.set("user", { uuid: (0, _v2.default)(), name: "" });
      }
      return user.uuid;
    ...
    value: function setName(name) {
      var user = _localStorage2.default.get("user");
      user.name = name;
      _localStorage2.default.set("user", user);
    }
  }, {
    key: "getName",
...
var LocalStorage = function () {
  function LocalStorage() {
    ...
    this.dataPath = _path2.default.resolve(__dirname + "/../data/", "storage.json");
    if (_fs2.default.existsSync(this.dataPath)) {
      var str = _fs2.default.readFileSync(this.dataPath);
      if (str.length == 0) {
        str = "{}";
      }
      ...
      this._data = {};
      if (!_fs2.default.existsSync(_path2.default.resolve(__dirname + "/../data/"))) _fs2.default.mkdirSync(_path2.default.resolve(__dirname + "/../data/"));
    }
    this.get.bind(this);
    this.set.bind(this);
  }
  ...
  _createClass(LocalStorage, [{
    ...
    value: function set(key, value) {
      ...
      _fs2.default.writeFileSync(this.dataPath, JSON.stringify(this._data));
    }
  }], [{
    key: "_sharedInstance",
    value: function _sharedInstance() {
      if (!_instance) {
